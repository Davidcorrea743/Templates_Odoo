 ...
 * Se ejecuta inmediatamente (no espera DOMContentLoaded) para evitar
 * el flash de tema incorrecto (FOUC).
 * --------------------------------------------------------------------- */
(function () {
    'use strict';
